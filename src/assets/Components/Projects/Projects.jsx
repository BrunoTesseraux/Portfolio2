...
const Projects = () => {
    const testData = [
        ...
        },
        {
            ...
            beschreibung: "Ziel dieses Projektes war es, sich mit APIs vertraut zu machen. Den Fetch haben wir in der Gruppe geschrieben. Neben grundlegenden Komponenten habe ich den Dark-Mode implementiert."
        },   
        {
            title: "Movie DB",
            ...
            beschreibung: "Die Movie DB war unser Frontend-Abschlussprojekt. Ziel war es, ein vorgegebenes Design umzusetzen. In diesem Projekt habe ich die Slider erstellt und die dazugehörigen Fetches geschrieben. Des Weiteren habe ich wieder den Dark-Mode implementiert."
        },
        {
            title: "GrosShop",
